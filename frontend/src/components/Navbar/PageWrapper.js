            ...
            <div className="container-fluid px-4 px-lg-5">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="nav navbar-nav ms-auto mb-2 mb-lg-0 ms-lg-4 nav-fill">
                        ...
                        {/* IF LOGGED IN SHOW CREATE NEW USER, OTHERWISE SHOW REGISTER */}
                        {
                            authState?.isAuthenticated && isAdmin == true ? (
                                <div className="ms-auto mb-lg-0">
                                    ...
                                    <li className="nav-item dropdown"> <a className="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Admin</a>
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">                        
                        ...
                        {/* IF LOGGED IN SHOW ICON, OTHERWISE, DO NOT */}
                        {
                            authState?.isAuthenticated ? (
                                <div className="ms-auto mb-lg-0">
                                    <li className="nav-item"><img src="https://icons.veryicon.com/png/o/miscellaneous/two-color-icon-library/user-286.png" className="rounded-circle" width="40"></img></li>                                
                                </div>
                                    ) : (
                                <div className="ms-auto mb-4 mb-lg-0 mb-4">
                                </div>)
                        }
                        {/* IF LOGGED IN SHOW LOG OUT BUTTON, OTHERWISE SHOW LOG IN BUTTON */}
                        {
                            authState?.isAuthenticated ? (
