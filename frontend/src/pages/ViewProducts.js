...
({productId, productName, pricePerUnit, productQty, productImg, productDescription, showProduct}) =>(
    ...
    <ul className="list-inline m-0">
        ...
        <li className="list-inline-item">
            {(showProduct) &&
            <button onClick={(e)=>deleteProduct(productId,e)} className="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Deactivate"><i className="fa fa-eye-slash"></i></button>
}
{!(showProduct) &&
    <button onClick={(e)=>deleteProduct(productId,e)} className="btn btn-success btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Activate"><i className="fa fa-eye"></i></button>
}
        </li>
        </ul>
        </td>
