...
public class UserCartController {
	...
	public ResponseEntity<UserCart> getById(@PathVariable Long userCartId) {
	...
	public void updateUserCart(@PathVariable("usercart_id") Long userCartId, @RequestBody UserCart userCart) {
		UserCart updateUserCart = userCartService.getUserCartById(userCartId).get();
	...
	public void deleteUserCart(@PathVariable("usercart_id") Long userCartId) {
		UserCart userCartRemoved = userCartService.getUserCartById(userCartId).get();
